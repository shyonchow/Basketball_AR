...
public class TKSwipeRecognizer : TKAbstractGestureRecognizer
{
    ...
    {
		return string.Format("{0}, swipe direction: {1}, swipe velocity: {2}, start point: {3}, end point: {4}, swipe Time: {5}",
			base.ToString(), completedSwipeDirection, swipeVelocity, startPoint, endPoint, swipeTime);
    }
}
